...
export default function request(
  ...
  const baseURL = autoMatchBaseUrl(prefix).baseUrl;
  const optHeaders = autoMatchBaseUrl(prefix).headers;
  ...
  if (method === 'get') {
    ...
    const contentType = defaultConfig.headers['Content-Type'];
